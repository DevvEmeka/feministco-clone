...
const Finances = () => {
  return (
    ...
    <section className="bg-[#ffe369] pt-[100px] laptop:px-[130px] px-[30px] py-[80px] mx-auto">
      ...
      <p className="text-[1.18em] laptop:text-[1.5em] font-sans mb-[30px] laptop:leading-9 leading-7">
      ...
      <div className="laptop:flex laptop:pt-[50px] laptop:justify-between laptop:items-centers">
        ...
        <div className="laptop:flex-grow-0 laptop:flex-shrink-0 laptop:w-[52%] laptop:max-w-[52%] font-sans">
          <ul className="m-0 p-0 list-none grid gap-[0.5rem]">
            <li className="before-ti-star laptop:text-[1.4em] text-[1.1em] font-normal laptop:leading-7">Total disbursed = ₦60,403,235.00</li>
            <li className="before-ti-star laptop:text-[1.4em] text-[1.1em] font-normal laptop:leading-7">Total left = ₦87,452,553.28</li>
          </ul>
          ...
          <ul className="m-0 p-0 list-none grid gap-[0.5rem]">
            <li className="before-ti-star laptop:text-[1.4em] text-[1.1em] font-normal laptop:leading-7">
