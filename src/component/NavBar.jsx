    ...
    <header className="mx-auto z-10 max-w-[96.875rem] top-0 w-full absolute">
      <nav className=" bg-[#ffe369] flex justify-between w-full items-center left-0 right-0 py-[40px] px-[25px] laptop:pt-[2.5rem] laptop:pr-[7.5rem] laptop:pb-[2.5rem] laptop:pl-[7.1875rem]">
        ...
        <ul className="laptop:flex text-[1.02em] items-center ease-in font-mono font-medium hidden">
          <li className="text-[1.02em] mr-[3.125rem] cursor-pointer">#EndSARS</li>
          <li className="text-[1.02em] mr-[3.125rem] cursor-pointer">About Us</li>
          <li className="text-[1.02em] mr-[3.125rem] cursor-pointer">Account Summary</li>
          <li className="text-[1.02em] mr-[3.125rem] cursor-pointer">Contact Us</li>
          <li className="-mt-1">
            <button className="py-[0.5rem] px-[2.375rem] rounded-[3px] cursor-pointer bg-[#000] text-[#ffe369] mr-0">Join Us</button>
          </li>
        </ul>
